...
{   //////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(segment == "EG" || segment == "GE" && (gateway != "G5" && gateway != "G6")){
    TOF_constraint = 50; //days
    }

    if(segment == "EG" || segment == "GE" && gateway == "G5" ){
    TOF_constraint = 100; //days
    }

    if(segment == "EG" || segment == "GE" && gateway == "G6" ){
    TOF_constraint = 365; //days
    }

    if(segment == "GM" || segment == "MG" && gateway != "G6"){
    TOF_constraint = 365; //days
    }
